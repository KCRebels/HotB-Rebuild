...
/* Resolution 550/551 fixture discovery was useful during development but was
   intentionally removed from the permanent full regression. Candidate-family
   correctness remains covered above and runtime Apply/recovery coverage lives in
   practice-resolution-runtime.test.js. Keeping brute-force discovery in CI made
   every scheduler run needlessly expensive. */
...
/* Resolution 553 reachability result:
   On the real 13-player roster, no single early-departure or Hitting-Only setup
   change makes Block 11 (alone or combined) a uniquely verified Resolution choice.
   Do not ask for an on-device Block 11 test from an invented one-change fixture. */
