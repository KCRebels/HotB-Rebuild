...
assert.match(index,/manifest\.webmanifest\?v=20260921-launch226/,'canonical shell must cache-bust the manifest at the current installed-app generation');
assert.doesNotMatch(index,/manifest\.webmanifest\?v=20260919-launch138/,'canonical shell must not keep advertising the stale launch-138 manifest URL');
