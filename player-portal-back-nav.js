...
document.addEventListener('click',e=>{
 ...
 const tile=t.closest('[data-hbp-view]');if(tile){if(tile.dataset.hbpView==='trends'||tile.dataset.hbpView==='practice'||tile.dataset.hbpView==='library')return;savePortal();return}
