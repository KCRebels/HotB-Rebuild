(() => {
  ...
  const pipe=()=>{const s=mk('|',C.black);s.style.margin='0 0.25em';return s};
  ...
  function rowFix(row){
    ...
    [...group.children].forEach(e=>{e.style.setProperty('font-size',cs.fontSize,'important');e.style.setProperty('font-weight',cs.fontWeight,'important');e.style.setProperty('font-family',cs.fontFamily,'important');e.style.setProperty('padding','0','important');e.style.setProperty('width','auto','important');e.style.setProperty('flex','none','important')});
  }
