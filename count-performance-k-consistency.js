(() => {
  ...
  const STAT_COLS='34px 10px 48px 10px 34px 10px 72px';
  ...
  function normalizePanel(row){
    ...
    header.style.cssText='display:flex!important;align-items:center!important;justify-content:space-between!important;gap:10px!important;width:100%!important;margin:0 0 10px!important;position:static!important;';
    title.style.cssText='margin:0!important;white-space:nowrap!important;line-height:1!important;flex:0 0 auto!important;';
    key.style.cssText=`display:grid!important;grid-template-columns:${STAT_COLS}!important;column-gap:2px!important;align-items:center!important;margin:0 0 0 auto!important;position:static!important;right:auto!important;top:auto!important;width:auto!important;flex:0 0 auto!important;`;
  ...
  function fixRow(row){
    ...
    row.style.cssText+=`display:grid!important;grid-template-columns:minmax(64px,1fr) ${STAT_COLS}!important;align-items:center!important;column-gap:2px!important;width:100%!important;white-space:nowrap!important;min-width:0!important;`;
