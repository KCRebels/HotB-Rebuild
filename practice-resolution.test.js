...
assert.ok((source.match(/bundle:'resolution453'/g)||[]).length>=3,"all current mobile Resolution diagnostic branches must identify the current bounded implementation");
