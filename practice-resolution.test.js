...
assert.equal(/(^|[^$])\$\('\[data-accommodation-arrival\],\[data-accommodation-departure\],\[data-accommodation-pitch\],\[data-accommodation-warmup\],\[data-accommodation-catch\],\[data-accommodation-prepractice\],\[data-accommodation-limitations\]'\)\.forEach/m.test(source),false,"Practice Builder must never call forEach on the single-element selector helper");
