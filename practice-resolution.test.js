...
assert.ok((source.match(/bundle:'resolution450'/g)||[]).length>=3,"all current mobile Resolution diagnostic branches must identify the current bounded implementation");
