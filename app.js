...
async function recoverOrphanedActivePractice(){
 ...
 try{
  ...
  const recoveredChosenDrills=chosenDrills;
  practicePlan=recoveredPlan;practiceChosenDrills=recoveredChosenDrills;practiceDraftDrills=[];practiceDrillPickerOpen=false;practiceEquipmentSetupOpen=false;practiceSection='builder';
