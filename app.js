...
function homeView(){
 ...
 return `<div class="home-hero">
   ...
   <div class="home-actions">
    <button class="home-card primary home-card-featured home-card-new" data-go="new"><img class="home-new-game-icon" src="home-new-game.png" alt="" aria-hidden="true"><h3>New<br>Game</h3><span class="home-card-chevron" aria-hidden="true">›</span></button>
