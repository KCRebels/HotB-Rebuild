...
const PORTAL_BUILD_TOKEN='20260919-196';window.HOTB_PORTAL_BUILD_TOKEN=PORTAL_BUILD_TOKEN;
...
try{render()}
 ...
 const app=document.getElementById('app');
 if(app)app.innerHTML=`<div class="app"><main style="padding:24px;font-family:-apple-system,BlinkMacSystemFont,Segoe UI,sans-serif"><section style="max-width:520px;margin:40px auto;background:#fff;border:2px solid #d4d9d7;border-radius:18px;padding:24px"><strong>HotB Startup Error</strong><p style="margin:8px 0 0">HotB loaded your saved data but could not draw the opening screen.</p><p style="margin:8px 0 0">Error code: H196-RENDER</p></section></main></div>`;
}
if(portalToken){
