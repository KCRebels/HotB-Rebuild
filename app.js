...
function homeView(){
 ...
 return `<div class="home-hero">
   ...
   <div class="home-actions">
    ...
    <button class="home-card cloud-card ${cloudError?'attention':cloudLastBackup?'healthy':''}" id="openCloudBackup"><span class="home-cloud-icon" aria-hidden="true"><svg viewBox="0 0 64 64" width="44" height="44" fill="none" stroke="currentColor" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"><path d="M18 48h29a11 11 0 0 0 1-22 17 17 0 0 0-32-4A13 13 0 0 0 18 48Z"/><path d="M23 34a10 10 0 0 1 16-5"/><path d="m39 24 1 6-6 1"/><path d="M41 38a10 10 0 0 1-16 5"/><path d="m25 48-1-6 6-1"/></svg></span><h3>Cloud<br>Backup</h3></button>
   </div>
