...
function bind(){
 ...
 if(modal==='practiceResolution'){
  ...
  $('#applyPracticeCombinedResolution')?.addEventListener('click',()=>{
...
function bindPractice(){
 ...
 $('#generatePractice')?.addEventListener('click',()=>{
  ...
  if(practicePlan.feasibilityErrors?.length){
   ...
   let canExtend=false,combinedPitchers=[];
   ...
   practiceResolution={errors,pitchers:solvingPitchers,canExtend,combinedPitchers,rosterGuidance,practicePlayers,startTime,durationMinutes,noPitchersMode,notices:practicePlan.fallbackWarnings||[]};
