...
function homeView(){
 ...
 return `<div class="home-hero">
   ...
   <div class="home-actions">
    ...
    <button class="home-card cloud-card ${cloudError?'attention':cloudLastBackup?'healthy':''}" id="openCloudBackup"><span class="home-cloud-icon home-cloud-css-icon" aria-hidden="true"><span class="cloud-upload-arrow"></span></span><h3>Cloud<br>Backup</h3></button>
   </div>
