...
function playerEvaluationPortalPayload(playerName){
 ...
 return JSON.parse(JSON.stringify({roster,savedGames:games,currentGame:null,evaluationSeason:season,evaluationFilterLabel,playerMetrics:{hotB:playerMetrics.hotB}}));
}
