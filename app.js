...
function homeView(){
 ...
 const icons={
  game:'<svg viewBox="0 0 64 64" aria-hidden="true"><circle cx="24" cy="10" r="5"/><path d="M21 17l11 8 10-3 3 5-14 7-7-6-5 13L8 55l-6-5 11-15 4-15z"/><path d="M33 21L58 7l2 4-25 15z"/></svg>',
  reports:'<svg viewBox="0 0 64 64" aria-hidden="true"><rect class="navy" x="7" y="36" width="13" height="22" rx="2"/><rect class="red" x="26" y="22" width="13" height="36" rx="2"/><rect class="gray" x="45" y="10" width="13" height="48" rx="2"/></svg>',
  eval:'<svg viewBox="0 0 64 64" aria-hidden="true"><rect class="paper" x="9" y="10" width="39" height="45" rx="3"/><path class="line" d="M18 40h20M18 34l7-8 6 5 8-13M22 10V5h14v5"/><circle class="person" cx="48" cy="45" r="6"/><path class="person" d="M37 61c0-9 4-13 11-13s11 4 11 13z"/></svg>',
  roster:'<svg viewBox="0 0 64 64" aria-hidden="true"><circle cx="32" cy="20" r="9"/><circle cx="13" cy="24" r="7"/><circle cx="51" cy="24" r="7"/><path d="M18 58c0-14 6-22 14-22s14 8 14 22M1 57c0-12 4-20 13-20 4 0 8 2 11 5M63 57c0-12-4-20-13-20-4 0-8 2-11 5"/></svg>',
  practice:'<svg viewBox="0 0 64 64" aria-hidden="true"><path d="M12 58h31M20 58V30h14v28M17 30h20"/><circle cx="27" cy="20" r="8"/><circle class="ball" cx="49" cy="14" r="6"/><circle class="ball" cx="56" cy="5" r="4"/></svg>',
  cloud:'<svg viewBox="0 0 64 64" aria-hidden="true"><path class="cloud" d="M13 52h35c9 0 14-6 14-14 0-7-5-13-12-14C47 13 39 7 29 9 20 10 14 16 12 25 5 27 1 32 1 39c0 8 5 13 12 13z"/><path class="arrow" d="M32 57V32m-9 9 9-9 9 9"/></svg>'
 };
 const card=(go,label,icon,cls='',id='')=>`<button class="home-card ${cls}" ${id?`id="${id}"`:`data-go="${go}"`}><span class="home-card-icon">${icons[icon]}</span><h3>${label}</h3><span class="home-chevron">›</span></button>`;
 return `<div class="home-hero approved-home">
  <div class="home-brand"><div class="approved-wordmark"><b class="approved-rebels">REBELS</b><b class="approved-hotb">HotB</b><i class="approved-bat"></i><span>Elite Hitting App</span></div></div>
