...
function homeView(){
 ...
 return `<div class="home-hero">
   ...
   <div class="home-actions">
    <button class="home-card primary home-card-featured home-card-new" data-go="new"><img class="home-new-game-icon" src="home-new-game.png" alt="" aria-hidden="true"><h3>NEW GAME</h3><span class="home-card-chevron" aria-hidden="true">›</span></button>
    ...
    <button class="home-card home-card-roster" data-go="roster"><img class="home-roster-icon" src="https://www.clipartmax.com/png/middle/435-4359822_staff-members-team-black-icon.png" alt="" aria-hidden="true"><h3>Edit Roster</h3></button>
    <button class="home-card home-card-practice" data-go="practice"><img class="home-practice-icon" src="home-hitting-practice.png" alt="" aria-hidden="true"><h3>${practicePlan||db.activePracticeSession?'Resume Hitting Practice':'Hitting Practice'}</h3></button>
