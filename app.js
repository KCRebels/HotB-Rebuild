...
function homeView(){
 ...
 return `<div class="home-hero">
   ...
   <div class="home-actions">
    ...
    <button class="home-card cloud-card ${cloudError?'attention':cloudLastBackup?'healthy':''}" id="openCloudBackup"><img class="home-cloud-icon" src="home-cloud-backup.png" alt="" aria-hidden="true"><h3>Cloud<br>Backup</h3></button>
   </div>
