...
function homeView(){
 ...
 return `<div class="home-hero">
   ...
   <div class="home-actions">
    ...
    <button class="home-card cloud-card ${cloudError?'attention':cloudLastBackup?'healthy':''}" id="openCloudBackup"><span class="home-cloud-icon" aria-hidden="true"><svg viewBox="0 0 64 48" focusable="false"><path d="M17 39H13C6 39 2 34 2 28c0-6 4-11 10-12C14 7 21 2 31 2c10 0 18 6 20 15 7 0 11 5 11 11 0 6-4 11-11 11h-4" fill="none" stroke="currentColor" stroke-width="5" stroke-linecap="round" stroke-linejoin="round"/><path d="M42 23a14 14 0 0 0-22-2M20 21l1-7 7 3M22 32a14 14 0 0 0 22 2M44 34l-1 7-7-3" fill="none" stroke="currentColor" stroke-width="5" stroke-linecap="round" stroke-linejoin="round"/></svg></span><h3>Cloud<br>Backup</h3></button>
   </div>
