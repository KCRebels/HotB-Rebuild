...
function homeView(){
 ...
 return `<div class="home-hero">
   ...
   <div class="home-actions">
    ...
    <button class="home-card cloud-card ${cloudError?'attention':cloudLastBackup?'healthy':''}" id="openCloudBackup"><span class="home-cloud-icon home-cloud-sync" aria-hidden="true"><span class="cloud-outline"></span><span class="sync-arrow sync-arrow-a"></span><span class="sync-arrow sync-arrow-b"></span></span><h3>Cloud<br>Backup</h3></button>
   </div>
