...
assert(index.includes('app.js?v=20260919-boot154'));
...
assert(pwa.includes("BUILD_VERSION = '2026.09.19.154'"));
assert(worker.includes("BUILD_VERSION = '2026.09.19.154'"));
assert(index.includes('pwa-update.js?v=20260919-pwa154'));
assert(index.includes('app.js?v=20260919-boot154'));
